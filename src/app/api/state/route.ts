            ...
            data: {
              ...
              portfolioCompanies: {
                create: (cp.portfolioCompanies ?? []).map((pc, idx) => ({
                  ...
                  status: pc.status,
                  investmentDate: pc.investmentDate ?? null,
                  exitDate: pc.exitDate ?? null,
                  holdingPeriod: pc.holdingPeriod ?? null,
                  exitMethod: pc.exitMethod ?? null,
                  geography: pc.geography ?? null,
                  industry: pc.industry ?? null,
                  proceeds: pc.proceeds ?? null,
