...
export const seedData: FinanceState = {
  ...
  assets: [
    ...
    { id: 'asset-insigai', name: 'Insig AI (Options)', currentValue: 0, annualGrowthRate: 0, category: 'angel', isLiquid: false, notes: '1.5M options at 50p exercise. Vesting: 1M Apr 2026, 500K Apr 2027. Currently out of the money (~28p share price Nov 2025)', provider: 'Insig AI', instrument: 'options', status: 'active', platform: 'direct' },
