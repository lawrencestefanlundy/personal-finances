  ...
  carryPositions: [
    {
      ...
      portfolioCompanies: [
        // Current Portfolio (16 companies) — Q4 2025 report (31 Dec 2025)
        {
          ...
          status: 'marked_up',
          notes:
            'FHE cryptography — 33x MOIC, mainnet launched Dec 2025, $ZAMA token sale $550M FDV',
        },
        {
          id: 'pco-molecule',
          name: 'Molecule',
        ...
        },
        {
          ...
          status: 'marked_up',
          notes: 'Geodistributed databases — 2.59x MOIC',
        },
        {
          id: 'pco-hathora',
          name: 'Hathora',
        ...
        },
        {
          ...
          status: 'active',
          notes:
            'Computer vision for lab automation — 0.92x MOIC, $100k follow-on, Breakout Ventures led $4M round',
        },
        {
          id: 'pco-emm',
          name: 'Emm Technology',
          ...
          ownershipPercent: 0,
          status: 'active',
          notes: 'FemTech wearables — $9M seed announced, emerged from stealth',
        },
        {
          id: 'pco-sodadata',
          name: 'Soda Data',
        ...
        },
        {
          ...
          ownershipPercent: 0,
          status: 'written_off',
          notes: 'Computer vision — Dec 2019 to Dec 2023, partial recovery €44K (0.09x)',
        },
        {
          id: 'pco-kyso',
          name: 'Kyso',
        ...
        },
        {
          ...
          ownershipPercent: 0,
          status: 'written_off',
          notes: 'CI/CD DevTool — Sep 2022 to Jun 2025, partial recovery €10K (0.02x)',
        },
        {
          id: 'pco-wayfare',
          name: 'Wayfare',
          ...
          ownershipPercent: 0,
          status: 'written_off',
          notes: 'Modern data stack — Mar 2023 to Jun 2025, write-off',
        },
      ],
      linkedAssetId: 'asset-lunar1',
      notes:
        'Berlin Innovation Ventures 1 GmbH & Co. KG — vintage 2019, 10yr term to Aug 2029. Q4 2025 report (31 Dec 2025). All values in EUR. 26 companies total (16 current + 9 write-offs + 1 secondary exit). Total cost basis €23.2M, FMV €52.0M. Gross MOIC 2.30x, TVPI 1.71x, Gross IRR 29%, Net IRR 17%. Hurdle exceeded. 3.763% personal carry share.',
    },
    {
      id: 'carry-lunar2',
      ...
      portfolioCompanies: [
        // Current Portfolio (9 companies) — Q4 2025 report (31 Dec 2025)
        {
          ...
          status: 'active',
          notes: 'Cloud infrastructure optimization — new Q4 2025, led $2.7M round',
        },
        {
          id: 'pco-xorq',
          name: 'Xorq',
        ...
        },
        {
          ...
          status: 'active',
          notes: 'Ballistic shipping — Vehicle 0 assembled, SOCOM $3-15M contract invite',
        },
        {
          id: 'pco-axiom',
      ...
      notes:
        'Lunar Ventures 2 SCSp — vintage 2023, 10yr term to Sep 2033. Q4 2025 report (31 Dec 2025). Final close at €49.3M. All values in EUR. 10 companies total (9 current + 1 secondary exit). Total cost basis €8.6M, FMV €8.4M. Gross MOIC 1.11x, TVPI 0.78x, Net IRR -20.3%. DPI 0.09x (Runware). 2% personal carry share, linear vesting Sep 2023–Sep 2027. Hurdle not yet exceeded. Lawrence now Venture Partner.',
    },
  ],
