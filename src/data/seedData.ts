...
export const seedData: FinanceState = {
  ...
  assets: [
    ...
    { id: 'asset-angel-bluejay', name: 'Bluejay', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-bonnet', name: 'Bonnet', currentValue: 0, annualGrowthRate: 0, category: 'angel', isLiquid: false, notes: 'Exited investment' },
    { id: 'asset-angel-callosum', name: 'Callosum', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-catapult', name: 'Catapult', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-charm', name: 'Charm Therapeutics', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-elemendar', name: 'Elemendar', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-nevermined', name: 'Nevermined', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-rain', name: 'Rain', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-roleshare', name: 'Roleshare', currentValue: 0, annualGrowthRate: 0, category: 'angel', isLiquid: false, notes: 'Exited investment' },
    { id: 'asset-angel-telesqobe', name: 'Telesqobe', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-uhubs', name: 'Uhubs', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
    { id: 'asset-angel-upside', name: 'Upside Money', currentValue: 6800, annualGrowthRate: 0, category: 'angel', isLiquid: false },
